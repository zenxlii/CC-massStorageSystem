...
local function installMSS()
	...
	downloadFile("commonCodeDisk.lua", "defaultConfigs/defaultCommonCodeDisk.lua")
	...
	downloadFile(commonCodePath.."/commonCodeDisk.lua", "defaultConfigs/defaultCommonCodeDisk.lua")
	...
	replaceLineInFile(commonCodePath.."/configFiles/config.lua", 20, "local importBuffer = "..stringWrap(importBuffer))
	print("Altered importBuffer!")
	replaceLineInFile(commonCodePath.."/configFiles/config.lua", 29, "local clientExportBuffer = "..stringWrap(exportBuffer))
	print("Altered clientExportBuffer!")
	replaceLineInFile(commonCodePath.."/commonCodeDisk.lua", 4, "local commonCodeDisk = "..stringWrap(commonCodePath))
	print("Altered the remote commonCodeDisk!")
	replaceLineInFile("commonCodeDisk.lua", 4, "local commonCodeDisk = "..stringWrap(commonCodePath))

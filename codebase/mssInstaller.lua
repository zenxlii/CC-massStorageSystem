...
local function installMSS()
	...
	downloadFile("mss/commonCodeDisk.lua", "defaultConfigs/defaultCommonCodeDisk.lua")
	downloadFile("mss/mssServer.lua", "server/mssServer.lua")
	downloadFile("mss/recipeListLoader.lua", "server/recipeListLoader.lua")
	downloadFile("mss/configFiles/storageList.lua", "defaultConfigs/defaultStorageList.lua")
	downloadFile(commonCodePath.."/mss/commonCodeDisk.lua", "defaultConfigs/defaultCommonCodeDisk.lua")
